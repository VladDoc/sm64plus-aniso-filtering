...
DEFINE_LEVEL("BIG BOO'S HAUNT",     LEVEL_BBH,              COURSE_BBH,      bbh,              spooky,   28000,    0x28, 0x28, 0x28, sDynBbh,   sCamBBH)
DEFINE_LEVEL("COOL COOL MOUNTAIN",  LEVEL_CCM,              COURSE_CCM,      ccm,              snow,     17000,    0x10, 0x38, 0x38, _,         sCamCCM)
DEFINE_LEVEL("PEACH'S CASTLE",      LEVEL_CASTLE,           COURSE_NONE,     castle_inside,    inside,   20000,    0x20, 0x20, 0x30, _,         sCamCastle)
